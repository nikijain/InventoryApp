...
import sfatechgroup.inventory.adapter.LunPurchaseDetailAdapter;
import sfatechgroup.inventory.adapter.RateContractAdapter;
import sfatechgroup.inventory.model.DetailsModel;

public class LUNPurchaseDetails extends AppCompatActivity {

    RecyclerView recyclerView;
    LunPurchaseDetailAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunpurchase_details);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("LUN Purchase Details ");
    ...
    private void initializeAdapter() {
        adapter = new LunPurchaseDetailAdapter(detailsModels, getApplicationContext());
